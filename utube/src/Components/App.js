...
function App() {
  ...
  // const defaultHeader = 'https://www.pjlewis.org/wp-content/uploads/2015/05/default-header.jpg';
  ...
  const defaultHeader = process.env.PUBLIC_URL + '/images/default_header2.png';
